...
public class Launcher extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        TimeSlotAdder.startThisView();
        // TODO add your handling code here:
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String[] wdKeys = {"activity"};
        String[] wdValues = new String[1];
        for(int x = 0; x < 7; x++){
            wdValues[0] = ""+workingDays[x]+"";
            DBConn.executeUpdate("working_days", "day_id", ""+x+"", wdKeys, wdValues);
        }
        String[] whKeys = {"start_time", "start_ampm", "end_time", "end_ampm"};
        String[] whValues = {time[jComboBox1.getSelectedIndex()], am_pm[jComboBox2.getSelectedIndex()], time[jComboBox3.getSelectedIndex()], am_pm[jComboBox4.getSelectedIndex()]};
        DBConn.executeUpdate("working_time", "interval_id", "0", whKeys, whValues);
